...
export const testimonialsData = [
  {
    ...
    feedback:
      "ResumeX helped me refine my resume like never before. The AI feedback was precise and job-targeted. Landed 3 interviews within a week!",
  },
  {
    name: "Priya Verma",
    role: "UI/UX Designer",
    ...
    feedback:
      "I loved the simplicity. Just upload your resume and let AI do the rest. Highly recommended for freshers and experienced folks alike.",
  },
  {
    name: "Rahul Mehta",
    ...
    feedback:
      "This tool saved me hours. The suggestions were relevant and well-structured. Definitely a must-have for job seekers.",
  },
];